[Lasso_Comment]
<fusedoc fuse="dsp_wireframes.lasso" language="Lasso">
	<responsibilities>
...
<p>
Wireframes work beautifully with <a href="[$self]?fuseaction=[$xfa_personas]">Persona Goals</a>. Think of a persona goal as the last step of a wireframe process. As an architect, you have to figure out the steps the persona will go through to achieve their goal. When you have a solution to acheive each of the persona's goals, you're done with your wireframe.
<p>
Don't dwell on the wireframes for too long. It's okay if they're incomplete. You're on the right track to a successful project, so now we need to show the application in detail by creating a <a href="[$self]?fuseaction=[$xfa_prototyping]">prototype</a>.
<br>
<br>
<h2>Tools</h2>
<p>Coming Soon<br>
