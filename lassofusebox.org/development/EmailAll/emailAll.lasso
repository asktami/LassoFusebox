...
[Inline: -FindAll,
    -Database='LFB_database1',
	-Username='LFB_lassofusebox',
	-Password='xobesufossal',
    -Table='Users',
    -KeyField='ID',
	-MaxRecords='ALL',
	-InlineName='getAll']
...
[Records: -InLineName='getAll']
    [Field: 'ID'] [Field: 'FirstName']  [Field: 'LastName']  [Field: 'Email']<br>
	[Lasso_Comment]
	[Email_Send: -Host='mail.pointinspace.com',
		-To=(Field: 'ID'),
		-From='michael@lassofusebox.org',
		-Subject=($subject),
		-Body=($body)]
	[/Lasso_Comment]
[/Records]