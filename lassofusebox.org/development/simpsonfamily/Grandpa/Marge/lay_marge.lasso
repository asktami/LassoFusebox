[Lasso_Comment]
<fusedoc fuse="lay_marge.lasso" language="Lasso" specification="3.0">
	<responsibilities>
...
<table width="90%" height="90%" align="center" valign="center" cellpadding="15" border="2" cellspacing="0" bordercolor="FF0000">
	<tr>
		<td colspan="2">
	...
	<tr height="100%">
		<td valign="top" nowrap>
			...
			<img src="images/lisa.gif"><a href="index.lasso?fuseaction=Lisa.main">Lisa</a><br>
			<img src="images/Maggie.gif"><a href="index.lasso?fuseaction=Maggie.main">Maggie</a><br>
		</td>
