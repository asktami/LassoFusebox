...
<br>
<br>
Look at those two files to see how the nesting works. The important variable to understand is the [Output: $layout, -EncodeNone] variable. It is in each of the lay_[name].lasso [/noprocess]
</p>
</td>
</tr>
</table>